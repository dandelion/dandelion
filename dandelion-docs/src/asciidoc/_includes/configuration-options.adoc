...
==== 12.1.2. Example using classpath configuration
...
==== 12.1.3. Example using externalized configuration
...
=== 12.2. Overloading default options
...
==== 12.4.2. Activating an option group
