	...
	public void should_return_relative_web_path() {
		...
		assertThat(
				PathUtils.getRelativeWebPath("http://dandelion.github.io/",
						"http://dandelion.github.io/folder/index.html")).isEqualTo("folder/index.html");
		assertThat(
				PathUtils.getRelativeWebPath("http://dandelion.github.io/folder/index.html",
						"http://dandelion.github.io/")).isEqualTo("../../");
	}
